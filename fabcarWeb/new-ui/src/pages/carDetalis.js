  ...
  return (
    ...
    <br/>
      <Container style={{border:'2px solid black', padding:'2rem',color:'#484a4a'}}>
        ...
        <h2> Car Manufacturer <span style={{color:'#054c5c'}}>{carDetails}</span></h2>
        <h2> Car Model <span style={{color:'#054c5c'}}>{carModel}</span> </h2>
        <h2> Car Color <span style={{color:'#054c5c'}}>{carColor}</span>  </h2>
        <h2> Car Owner <span style={{color:'#054c5c'}}>{carOwner}</span></h2>
          <br/>
